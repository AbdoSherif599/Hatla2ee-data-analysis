...
\begin{itemize}
    ...
    \item \textbf{Structured Output Parsing:} Using the \textbf{Pydantic} library, a strict schema was enforced. The LLM successfully extracted "hidden" metrics from the Arabic paragraphs, including exact engine capacity (CC), horsepower, drivetrain configuration (e.g., 4WD, FWD), specific trim levels, and critical valuation metrics like paint condition (e.g., "Factory Paint" or "Zero").
